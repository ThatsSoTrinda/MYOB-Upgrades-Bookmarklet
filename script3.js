(function (e, t) {
  ...
  function E() {
    var t = e.innerWidth || s.clientWidth,
      n = e.outerWidth || e.screen.width;
    (h.screen.innerWidth = t), (h.screen.outerWidth = n);
    var r = e.outerWidth || s.clientWidth;
    (s.className = s.className.replace(
      / (w|lt|portrait|no-portrait|landscape|no-landscape)-\d+/g,
      ""
    )),
      f("w-" + Math.round(r / 100) * 100),
      c(u.screens, function (e) {
        r <= e && f("lt-" + e);
      });
    var i = e.innerHeight || s.clientHeight,
      o = e.outerHeight || e.screen.height;
    (h.screen.innerHeight = i),
      (h.screen.outerHeight = o),
      h.feature("portrait", i > t),
      h.feature("landscape", i < t);
  }
  function x() {
    e.clearTimeout(S), (S = e.setTimeout(E, 100));
  }
  var n = e.document,
    r = e.navigator,
    i = e.location,
  ...
  if (e.head_conf)
    for (var a in e.head_conf) e.head_conf[a] !== t && (u[a] = e.head_conf[a]);
  var h = (e[u.head] = function () {
    h.ready.apply(null, arguments);
  });
  (h.feature = function (e, t, n) {
    return e
      ? (Object.prototype.toString.call(t) === "[object Function]" &&
          (t = t.call()),
        f((t ? "" : "no-") + e),
        (h[e] = !!t),
        n || (l("no-" + e), l(e), h.feature()),
        h)
      : ((s.className += " " + o.join(" ")), (o = []), h);
  }),
    h.feature("js", !0);
  var p = r.userAgent.toLowerCase(),
    d = /mobile|midp/.test(p);
  h.feature("mobile", d, !0),
    h.feature("desktop", !d, !0),
    h.feature("touch", "ontouchstart" in e, !0),
    (p =
  ...
  switch (v) {
    case "msie":
      (v = "ie"), (m = n.documentMode || m), (g = 6), (y = 10);
      break;
    case "chrome":
      (g = 8), (y = 22);
      break;
  ...
  (h.browser = { name: v, version: m }), (h.browser[v] = !0);
  var b = ["ie"];
  c(b, function (e) {
    e === v ? f(e) : f("no-" + e);
  });
  for (var w = g; w <= y; w++) m < w && f("lt-" + v + w);
  v === "ie" &&
    m < 9 &&
    c(
    ...
    c(i.pathname.split("/"), function (e, n) {
      if (this.length > 2 && this[n + 1] !== t)
        n &&
          f(
            this.slice(1, n + 1)
              .join("-")
        ...
        i > 0 && (r = r.substring(0, i)),
          (s.id = r.toLowerCase() + u.page),
          n || f("root" + u.section);
      }
    }),
    (h.screen = { height: e.screen.height, width: e.screen.width }),
    E();
  var S = 0;
  e.addEventListener
    ? e.addEventListener("resize", x, !1)
    : e.attachEvent("onresize", x);
})(window),
  (function (e, t) {
    "use strict";
    function l(e) {
      for (var n in e) if (s[e[n]] !== t) return !0;
    }
    function c(e) {
    ...
    var n = e.document,
      ...
      i = n.createElement("i"),
      s = i.style,
      o = " -o- -moz- -ms- -webkit- -khtml- ".split(" "),
      u = "Webkit Moz O ms Khtml".split(" "),
      a = (e.head_conf && e.head_conf.head) || "head",
      f = e[a],
      h = {
        gradient: function () {
          ...
          return (
            (s.cssText = (e + o.join(t + e) + o.join(n + e)).slice(
              0,
              -e.length
            )),
            !!s.backgroundImage
        ...
        rgba: function () {
          return (
            (s.cssText = "background-color:rgba(0,0,0,0.5)"),
            !!s.backgroundColor
          );
        },
        opacity: function () {
          return i.style.opacity === "";
        },
        textshadow: function () {
          return s.textShadow === "";
        },
        multiplebgs: function () {
          return (
            ...
            new RegExp("(url\\s*\\(.*?){3}").test(s.background)
          );
        },
        boxshadow: function () {
          return c("boxShadow");
        ...
        fontface: function () {
          var e = navigator.userAgent,
            t;
          return (t = e.match(/Chrome\/(\d+\.\d+\.\d+\.\d+)/))
            ? t[1] >= "4.0.249.4" || 1 * t[1].split(".")[0] > 5
            : (t = e.match(/Safari\/(\d+\.\d+)/)) && !/iPhone/.test(e)
            ? t[1] >= "525.13"
            : /Opera/.test({}.toString.call(window.opera))
            ? opera.version() >= "10.00"
            : (t = e.match(/rv:(\d+\.\d+\.\d+)[^b].*Gecko\//))
            ? t[1] >= "1.9.1"
            : !1;
        },
      };
    for (var p in h) h[p] && f.feature(p, h[p].call(), !0);
    f.feature();
  })(window),
  (function (e, t) {
    "use strict";
    ...
    function w(e) {
      var t;
      if (typeof e == "object")
        for (var n in e) e[n] && (t = { name: n, url: e[n] });
      else t = { name: b(e), url: e };
      var r = l[t.name];
      return r && r.url === t.url ? r : ((l[t.name] = t), t);
    }
    function E(e, t) {
      if (!e) return;
    ...
    function x(e) {
      ...
      var t;
      for (var n in e) {
        if (e.hasOwnProperty(n) && e[n].state != g) return !1;
        t = !0;
      }
      return t;
    }
    ...
    function N(e, n) {
      e.state === t &&
        ((e.state = v),
        (e.onpreload = []),
        k({ src: e.url, type: "cache" }, function () {
          T(e);
        }));
    }
    function C(e, t) {
      if (e.state == g) return t && t();
      if (e.state == m) return p.ready(e.name, t);
      if (e.state == v)
        return e.onpreload.push(function () {
          C(e, t);
        });
      (e.state = m),
        k(e.url, function () {
    ...
    var n = e.document,
      ...
      l = {},
      c =
        n.createElement("script").async === !0 ||
        "MozAppearance" in n.documentElement.style ||
        e.opera,
      h = (e.head_conf && e.head_conf.head) || "head",
      p = (e[h] =
        e[h] ||
        function () {
    ...
    c
      ...
      (p.ready = function (e, t) {
        if (e == n) return o ? y(t) : u.push(t), p;
        S(e) && ((t = e), (e = "ALL"));
        if (typeof e != "string" || !S(t)) return p;
        var r = l[e];
        if ((r && r.state == g) || (e == "ALL" && x() && o)) return y(t), p;
        var i = f[e];
        return i ? i.push(t) : (i = f[e] = [t]), p;
      }),
      p.ready(n, function () {
        x() &&
          E(f.ALL, function (e) {
          ...
          p.feature && p.feature("domloaded", !0);
      });
    ...
    !n.readyState &&
      ...
      n.addEventListener(
        "DOMContentLoaded",
        (handler = function () {
          n.removeEventListener("DOMContentLoaded", handler, !1),
...
var running = false;
var runningHTMLText = `<hr /><h1>Search active</h1>`;
...
runningHTML.innerHTML = runningHTMLText + "<hr />";
...
editSearchTimeButton.innerHTML = "Change search interval";

var reloadPageAfterCompletionButton = document.createElement("button");
reloadPageAfterCompletionButton.addEventListener("click", reloadPageHandler);
...
resetAverageTimeButton.innerHTML = "Reset average time";

var reloadPageAfterCompletion = false;
...
function checkCookie() {
    ...
    var CaudioEnabled = getCookie("audioEnabled");
    var CreloadPage = getCookie("reloadPage");
    var CaverageTime = getCookie("averageTime");

    if (CbatchesComplete != "") {
        batchesThisSessionCount = cBatchesComplete;
    }
    if (CledgersComplete != "") {
        ledgersThisSessionCount = CledgersComplete;
    }
    if (cSearchTime != "") {
        searchTime = cSearchTime;
    }
    if (CaudioEnabled != "") {
        audioEnabledBool = CaudioEnabled;
        setAudioEnabled();
    }
    if (CreloadPage != "") {
        reloadPageAfterCompletion = CreloadPage;
        reloadPageChange();
    }
    if (CaverageTime != "") {
        averageTimeAvg = CaverageTime;
...
function deleteAllCookies() {
    ...
    document.cookie = "Trin-audioEnabled=;Expires=Thu, 01 Jan 1970 00:00:01 GMT;Path=/"
    document.cookie = "Trin-reloadPage=;Expires=Thu, 01 Jan 1970 00:00:01 GMT;Path=/"
    ...
    audioEnabledBool = false;
    setAudioEnabled();

    reloadPageAfterCompletion = false;
    reloadPageChange();
...
function provisioningDB(document) {
  var numInProgress = 0;
  ...
  var timeElapsed = currentTime - startTime;
  var timeMessage = `Time elapsed: ${calculateDuration(timeElapsed)}`;
//  var timeMessage = `Time elapsed: ${timeDiffCalc(currentTime, startTime)}`;

  for (var i = 0; i < document.length; i++) {
    if (document[i].innerText.indexOf("Started") > -1) {
      if (document[i-1].innerText.indexOf("Provisioning database") > -1) {
        numInProgress += 1;
        provisioning = true;
        wasRun = false;
        setStartTime();
    ...
    if (document[i].innerText.indexOf("Upload Ledger") > -1) {
      numInProgress += 1;
      provisioning = true;
      wasRun = false;
      setStartTime();
    }
    if (document[i].innerText.indexOf("In progress") > -1) {
      numInProgress += 1;
      numInProgressText = `<h2>Found ${numInProgress.toString()} ledger(s) in progress.</h2>`;
      provisioning = true;
      wasRun = false;
      setStartTime();
    }
    if (document[i].innerText.indexOf("Completed") > -1) {
      if (!(document[i-1].innerText.indexOf("Upload Ledger") > -1)) {
        numCompleted += 1;
        numCompletedText = `<h2>Found ${numCompleted.toString()} ledger(s) completed.</h2>`;
      }
    }
    if (document[i].innerText.indexOf("Failed") > -1) {
      if (!(document[i].innerText.indexOf("Failed_") > -1)) {
        numFailed += 1;
        numFailedText = `<h2>Found ${numFailed.toString()} ledger(s) failed.</h2>`;
      }
    }
    if (document[i].innerText.indexOf("Manual Rollback") > -1) {
      for (var j = 0; j < document.length; j++) {
        if (document[j].innerText.indexOf("Failed") > -1) {
          numFailed -= 1;
        }
      }
    }
...
function preMigrating(document) {
  var numInProgress = 0;
  var numInProgressText = "";
  var numWaiting = 0;
  var numWaitingText = "";
  ...
  for (var i = 0; i < document.length; i++) {
    ...
    if (
      document[i].innerText.indexOf("Waiting for resource") > -1 ||
      document[i].innerText.indexOf("Remove from queue") > -1
    ) {
      numWaiting += 1;
      numWaitingText = `<h2>Found ${numWaiting.toString()} ledger(s) waiting to begin.</h2>`;
      running = true;
      wasRun = false;
      setStartTime();
    }
    if (document[i].innerText.indexOf("Started") > -1) {
        if (document[i-1].innerText.indexOf("Pre ETL migration") > -1) {
            numWaiting += 1;
            numWaitingText = `<h2>Found ${numWaiting.toString()} ledger(s) waiting to begin.</h2>`;
            running = true;
            wasRun = false;
    ...
    if (document[i].innerText.indexOf("Completed") > -1 || 
    document[i].innerText.indexOf("Pre Access Management") > -1) {
      numCompleted += 1;
      numCompletedText = `<h2>Found ${numCompleted.toString()} ledger(s) completed.</h2>`;
    }
    if (document[i].innerText.indexOf("Failed") > -1) {
